        ...
        <div className="glass-card" style={{ padding: '2rem' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.25rem' }}>
              <label htmlFor="accountName" style={{ display: 'block', fontSize: '0.8rem', fontWeight: '600', marginBottom: '0.5rem' }}>
                ACCOUNT HOLDER NAME
              </label>
            ...
            <div style={{ marginBottom: '2rem' }}>
              <label htmlFor="upiId" style={{ display: 'block', fontSize: '0.8rem', fontWeight: '600', marginBottom: '0.5rem' }}>
                YOUR UPI ID
              </label>
              <div className="input-with-icon">
                <Hash size={16} />
